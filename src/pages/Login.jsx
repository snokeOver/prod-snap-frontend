...
import LogoWithTitle from "../components/join_login/LogoWithTitle.jsx";
import GoogleButton from "../components/join_login/GoogleButton.jsx";
import GithubButton from "../components/join_login/GithubButton.jsx";
import SideSectionWithSlidder from "../components/join_login/SideSectionWithSlidder.jsx";
    ...
    <>
      ...
      <Container nopad="true">
        <div className="hero  rounded-xl flex flex-col lg:flex-row">
          ...
          >
            <SideSectionWithSlidder writings="Find and choose your favourite mobile phone" />
          </div>
        </div>
